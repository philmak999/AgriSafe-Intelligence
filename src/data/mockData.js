export const herds = [
  { id: 'ON-0142', farm: 'Thornfield Beef Co.', location: 'Elora, ON', species: 'Bovine', headCount: 840, vaccination: 78, lastInspection: 'Mar 27', mri: 28, risk: 'HIGH' },
  { id: 'NY-0311', farm: 'Maple Ridge Pork', location: 'Batavia, NYS', species: 'Swine', headCount: 1200, vaccination: 81, lastInspection: 'Mar 26', mri: 33, risk: 'HIGH' },
  { id: 'ON-0087', farm: 'Lakeshore Dairy', location: 'Brampton, ON', species: 'Bovine', headCount: 320, vaccination: 88, lastInspection: 'Mar 22', mri: 51, risk: 'MED' },
  { id: 'NY-0455', farm: 'Seneca Valley Farms', location: 'Geneva, NYS', species: 'Poultry', headCount: 4500, vaccination: 84, lastInspection: 'Mar 24', mri: 48, risk: 'MED' },
  { id: 'ON-0203', farm: 'Halton Heritage Farm', location: 'Milton, ON', species: 'Bovine', headCount: 180, vaccination: 95, lastInspection: 'Mar 12', mri: 79, risk: 'LOW' },
  { id: 'NY-0128', farm: 'Rochester Cold Storage', location: 'Rochester, NYS', species: 'Bovine', headCount: 610, vaccination: 91, lastInspection: 'Mar 24', mri: 71, risk: 'LOW' },
  { id: 'NY-0067', farm: 'Buffalo Export Facility', location: 'Buffalo, NYS', species: 'Poultry', headCount: 2100, vaccination: 93, lastInspection: 'Mar 23', mri: 79, risk: 'LOW' },
  { id: 'ON-0055', farm: 'Elmvale Sheep Co.', location: 'Elmvale, ON', species: 'Ovine', headCount: 260, vaccination: 87, lastInspection: 'Mar 15', mri: 66, risk: 'LOW' },
];
...
export const complianceReports = [
  ...
  { id: 'CR-2026-013', facility: 'Syracuse Packing Co.', regulation: 'CFIA Part 11', period: 'Q1 2026', filed: 'Mar 27', status: 'REVIEW', label: 'Pending' },
  ...
  { id: 'CR-2026-008', facility: 'Maple Ridge Pork', regulation: 'FSMA 204', period: 'Q4 2025', filed: 'Jan 06', status: 'REVIEW', label: 'Pending' },
];
